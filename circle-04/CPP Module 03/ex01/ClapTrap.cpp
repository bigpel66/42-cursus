...
ClapTrap::ClapTrap(void)
	: _name(ClapTrap::getClassName()), _hp(ClapTrap::getClassHP()), _ep(ClapTrap::getClassEP()), _ad(ClapTrap::getClassAD()), _max_hp(ClapTrap::getClassHP())
{
	std::cout << "[ " << ClapTrap::getClassName() << " ]"
...
ClapTrap::ClapTrap(const std::string& name)
	: _name(name), _hp(ClapTrap::getClassHP()), _ep(ClapTrap::getClassEP()), _ad(ClapTrap::getClassAD()), _max_hp(ClapTrap::getClassHP())
{
	std::cout << "[ " << ClapTrap::getClassName() << " ]"
					<< " [ login ] " << _name << std::endl;
}
...
ClapTrap::ClapTrap(const ClapTrap& c)
	: _name(c.getName()), _hp(c.getHP()), _ep(c.getEP()), _ad(c.getAD()), _max_hp(ClapTrap::getClassHP())
{
	std::cout << "[ " << ClapTrap::getClassName() << " ]"
					<< " [ login ] " << _name << std::endl;
}
